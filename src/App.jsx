  ...
  return (
      <div className={`${isDarkMode ? 'dark' : 'light'} overflow-x-hidden text-neutral-200 antialiased selection:bg-blue-300 selection:text-blue-700`}>
        ...
        <div className='fixed top-0 -z-10 h-full w-full'>
          {
            isDarkMode ? (
              <div class="relative h-full w-full bg-gray-900"><div class="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f_1px,transparent_1px)] bg-[size:64px_44px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div></div>
